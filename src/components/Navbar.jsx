            ...
            <div className="flex justify-between items-center layout-container h-20">
                ...
                <div className="hidden md:flex items-center gap-2 shrink-0">
                    ...
                    <button
                        ...
                        className={`font-headline font-bold text-xs uppercase tracking-wider px-5 py-2.5 rounded-full transition-all duration-300 ${activeTab === 'cards' || activeTab === 'card-detail'
                            ? 'bg-primary/15 text-primary border border-primary/30'
                            : 'text-on-surface-variant hover:text-primary hover:bg-surface-container-high'
                            }`}
                    >
                        <span className="material-symbols-outlined text-base align-middle mr-1" style={{ fontVariationSettings: "'FILL' 1" }}>style</span>
                        Cards
                    </button>
                    <button
            ...
            {isOpen && (
                <div className="md:hidden absolute top-20 left-0 w-full bg-background/95 backdrop-blur-2xl border-b border-outline-variant/20 shadow-2xl py-4 px-6 flex flex-col gap-3 animate-in fade-in slide-in-from-top-2 duration-200">
                    ...
                    <button
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-headline font-bold text-sm uppercase tracking-wider transition-colors text-left ${activeTab === 'cards' || activeTab === 'card-detail'
                            ? 'bg-primary/15 text-primary'
                            : 'text-on-surface hover:bg-surface-container-high'
                            }`}
                    >
