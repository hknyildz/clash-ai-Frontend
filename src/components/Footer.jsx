            ...
            <div className="flex flex-col md:flex-row justify-between items-center layout-container gap-8">
                ...
                <div className="flex gap-4">
                    ...
                    <div
                        ...
                        className="w-10 h-10 rounded-full bg-surface-container flex items-center justify-center text-tertiary/50 hover:text-primary transition-colors cursor-pointer border border-outline-variant/20"
                    >
