...
const InputSection = ({ tag, setTag, onGenerate, isLoading, showButton, activeTab }) => {
    ...
    // Don't show input section for clans/clan-detail/stats/favorites/calculator/cards tabs
    if (activeTab === 'clans' || activeTab === 'clan-detail' || activeTab === 'stats' || activeTab === 'favorites' || activeTab === 'calculator' || activeTab === 'cards' || activeTab === 'card-detail') return null;
